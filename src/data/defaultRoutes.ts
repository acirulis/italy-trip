...
export const DEFAULT_ROUTES: RouteItem[] = [
  ...
  },
  {
    ...
    trailDifficulty: 'Moderate',
    elevationGainM: 380,
    bestTimeToVisit: 'Warm midday to escape valley heat in refreshing alpine shade',
    description:
      'An extinct ancient volcano dominating the skyline of southern Tuscany. Its slopes are blanketed by Europe’s largest monumental beech forest, leading up to the iconic 22-meter iron monumental summit cross.',
    highlights: [
